...
namespace SiparisTakipApp
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			// barButtonItem5
			// 
			this.barButtonItem5.Caption = "Güncelle";
			...
			// barButtonItem7
			// 
			this.barButtonItem7.Caption = "Info";
			...
			// barButtonItem8
			// 
			this.barButtonItem8.Caption = "Kullanıcı Ayarlar\r\n";
			...
			// barButtonItem10
			// 
			this.barButtonItem10.Caption = "Info";
			...
			// barButtonItem11
			// 
			this.barButtonItem11.Caption = "Satışlar";
			...
			// barButtonItem12
			// 
			this.barButtonItem12.Caption = "Ürünler";
			...
			// barButtonItem13
			// 
			this.barButtonItem13.Caption = "Ürün Ekle";
			...
			// barButtonItem14
			// 
			this.barButtonItem14.Caption = "X raporu";
			...
			// barButtonItem15
			// 
			this.barButtonItem15.Caption = "Z raporu";
			...
			// barButtonItem16
			// 
			this.barButtonItem16.Caption = "Kullanıcı Ayarlar";
			...
			// barButtonItem17
			// 
			this.barButtonItem17.Caption = "Ürün Sil";
			...
			// barButtonItem18
			// 
			this.barButtonItem18.Caption = "Ürün Düzenle";
			...
			// barButtonItem19
			// 
			this.barButtonItem19.Caption = "Ürün Tür";
			this.barButtonItem19.Id = 22;
